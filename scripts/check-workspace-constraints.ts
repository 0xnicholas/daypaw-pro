...
// so it only owes `private: true` — the family proper plus the fork demo leaf
// under packages/examples/.
const releaseMemberDirectory =
  /^(?:packages\/(?!daypaw\/|examples\/daypaw-|experimental\/)[^/]+\/[^/]+|apps\/(?!daypaw-)[^/]+|vendor\/[^/]+)$/
/**
