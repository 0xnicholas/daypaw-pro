...
function parseMode(raw: string | undefined): Mode {
  switch (raw) {
    ...
    default:
      throw new Error(
        `run-gates: expected mode ci-primary | ci-linux-primary | ci-daypaw-hosted | ci-static | ci-lint-contracts-ready | ci-coverage | ci-bench | ci-snapshot | ci-artifacts | ci-consumers | ci-windows-blocking | ci-windows-complete | ci-windows-observational-ready | node-compat | check-all | hygiene | doc-sync | doc-quick, got ${JSON.stringify(raw)}.`,
      )
  }
}
