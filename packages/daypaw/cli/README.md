...
Requires Node `^22.19.0 || >=24.0.0` and a DeepSeek API key ([platform.deepseek.com](https://platform.deepseek.com)) — the shell calls the model on your key, billed to your account. `@daypaw/cli` is delivered as a tarball and is not published to the public registry.
