/**
 * Package-owned invariant companion for `@daypaw/ui-tasks`.
 * @module @daypaw/ui-tasks/invariant
 */
...
const PACKAGE_NAME = '@daypaw/ui-tasks'

/** Cordis companion plugin name. */
export const name = 'daypaw-ui-tasks-invariant'
/** Service required before the companion can reserve package ownership. */
export const inject = ['invariants']

/**
 * No runtime invariant: a pure-presentation plugin whose only state is the
 * apply-closure new-task store asserted directly by this package's
