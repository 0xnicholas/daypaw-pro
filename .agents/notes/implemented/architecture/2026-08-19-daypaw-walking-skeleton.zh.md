...
- 本 note 推迟的 promise 行、`waiting` 状态与 gate 决议已随 `ctx.waitFor` 落地（issue #47，[gate note](../feature/2026-08-23-durable-gate-waitfor.zh.md)）；timers 表与 `ctx.sleep` 已随[持久 timer](../feature/2026-09-19-daypaw-durable-timer.zh.md)落地；关系 invariant 仍是按需驱动的后续工作。
