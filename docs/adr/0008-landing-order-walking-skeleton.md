...
- **状态**：已接受（2026-08-17，[落地顺序与 walking skeleton](https://github.com/0xnicholas/daypaw-pro/issues/13)）；§4 的 map #1 雾区语句已由 ADR 0009 作废，后记中③④「里程碑」表述由 ADR 0009 接替（降级为远期子项目，无排期里程碑）
