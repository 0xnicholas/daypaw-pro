...
> Fork-specific additions below; everything above is upstream dsh guidance and stays upstream-owned (registered in `docs/fork/CORE_TOUCHES.md`).

## Agent skills

### Issue tracker

Issues are tracked as GitHub issues in `0xnicholas/daypaw-pro` via the `gh` CLI. See `docs/agents/issue-tracker.md`.
